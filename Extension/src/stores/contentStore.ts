// Context(AI) — Content Extraction Store
...
export const useContentStore = create<ContentState>()(
  persist(
      ...
      extractContent: async () => {
        ...
        try {
          ...
          const answer = await ApplicationService.askPageQuestion(
            "Please read the ENTIRE provided text from beginning to end. Provide a complete, comprehensive summary of the FULL text, ensuring you cover every section from the first to the last. Output the final combined summary exactly according to the strict OUTPUT REQUIREMENTS and QUALITY CHECK rules in your system prompt.",
            content,
            "summary"
    ...
    {
      name: "context-ai-content-storage",
      partialize: (state) => ({ 
